(function(m){"object"===typeof exports?module.exports=m():"function"===typeof define&&define.amd?define(m):geostats=m()})(function(){var m=function(h){return"number"===typeof h&&parseFloat(h)==parseInt(h,10)&&!isNaN(h)};Array.prototype.indexOf||(Array.prototype.indexOf=function(h,a){if(void 0===this||null===this)throw new TypeError('"this" is null or not defined');var b=this.length>>>0;a=+a||0;Infinity===Math.abs(a)&&(a=0);0>a&&(a+=b,0>a&&(a=0));for(;a<b;a++)if(this[a]===h)return a;return-1});return function(h){this.objectID=
...
a+" classes)";return this.bounds}};this.getClassStdDeviation=function(a,b){a=this._nbClassInt(a);if(!this._nodata()){var c=this.max(),d=this.min(),e=this.stddev(),g=this.mean(),f=[];if(1==a%2){var n=Math.floor(a/2),k=n+1;f[n]=g-e/2;f[k]=g+e/2;for(i=n-1;0<i;i--)g=f[i+1]-e,f[i]=g;i=k+1}else{k=a/2;f[k]=g;for(i=k-1;0<i;i--)g=f[i+1]-e,f[i]=g;i=k+1}for(;i<a;i++)g=f[i-1]+e,f[i]=g;f[0]="undefined"===typeof b?f[1]-e:d;f[a]="undefined"===typeof b?f[a-1]+e:c;this.setBounds(f);this.setRanges();this.method="std deviation ("+
...
return this.bounds}};this.getClassJenks2=function(a){a=this._nbClassInt(a);if(!this._nodata()){dataList=this.sorted();for(var b=[],c=0,d=dataList.length+1;c<d;c++){for(var e=[],g=0,f=a+1;g<f;g++)e.push(0);b.push(e)}c=[];d=0;for(e=dataList.length+1;d<e;d++){g=[];f=0;for(var n=a+1;f<n;f++)g.push(0);c.push(g)}d=1;for(e=a+1;d<e;d++){b[0][d]=1;c[0][d]=0;var k=1;for(g=dataList.length+1;k<g;k++)c[k][d]=Infinity;k=0}d=2;for(e=dataList.length+1;d<e;d++){n=f=g=0;for(var q=1,w=d+1;q<w;q++){var h=d-q+1;k=parseFloat(dataList[h-
1]);f+=k*k;g+=k;n+=1;k=f-g*g/n;var r=h-1;if(0!=r)for(var l=2,m=a+1;l<m;l++)c[d][l]>=k+c[r][l-1]&&(b[d][l]=h,c[d][l]=k+c[r][l-1])}b[d][1]=1;c[d][1]=k}k=dataList.length;c=[];for(d=0;d<=a;d++)c.push(0);c[a]=parseFloat(dataList[dataList.length-1]);c[0]=parseFloat(dataList[0]);for(d=a;2<=d;)e=parseInt(b[k][d]-2),c[d-1]=dataList[e],k=parseInt(b[k][d]-1),--d;c[0]==c[1]&&(c[0]=0);this.setBounds(c);this.setRanges();this.method="Jenks2 ("+a+" classes)";return this.bounds}};this.getClassJenks=function(a){a=
this._nbClassInt(a);if(!this._nodata()){dataList=this.sorted();jenksMatrices=function(a,b){var c=[],d=[],e,f,g=0;for(e=0;e<a.length+1;e++){var h=[],l=[];for(f=0;f<b+1;f++)h.push(0),l.push(0);c.push(h);d.push(l)}for(e=1;e<b+1;e++)for(c[1][e]=1,d[1][e]=0,f=2;f<a.length+1;f++)d[f][e]=Infinity;for(e=2;e<a.length+1;e++){for(var m=l=h=0,p,u=1;u<e+1;u++){var v=e-u+1;f=a[v-1];m++;h+=f;l+=f*f;g=l-h*h/m;p=v-1;if(0!==p)for(f=2;f<b+1;f++)d[e][f]>=g+d[p][f-1]&&(c[e][f]=v,d[e][f]=g+d[p][f-1])}c[e][1]=1;d[e][1]=
g}return{lower_class_limits:c,variance_combinations:d}};var b=jenksMatrices(dataList,a).lower_class_limits,c=dataList.length-1,d=[],e=a;d[a]=dataList[dataList.length-1];for(d[0]=dataList[0];1<e;)d[e-1]=dataList[b[c][e]-2],c=b[c][e]-1,e--;this.setBounds(d);this.setRanges();this.method="Jenks ("+a+" classes)";return this.bounds}};this.getClassUniqueValues=function(){if(!this._nodata()){this.is_uniqueValues=!0;var a=this.sorted(),b=[];for(i=0;i<this.pop();i++)-1===b.indexOf(a[i])&&b.push(a[i]);this.bounds=
b;this.method="unique values";return b}};this.getClass=function(a){for(i=0;i<this.bounds.length;i++)if(1==this.is_uniqueValues){if(a==this.bounds[i])return i}else if(parseFloat(a)<=this.bounds[i+1])return i;return"Unable to get value's class."};this.getRanges=function(){return this.ranges};this.getRangeNum=function(a){var b;for(b=0;b<this.ranges.length;b++){var c=this.ranges[b].split(/ - /);if(a<=parseFloat(c[1]))return b}};this.getInnerRanges=function(){if(null!=this.inner_ranges)return this.inner_ranges;
var a=[],b=this.sorted(),c=1;for(i=0;i<b.length;i++){if(0==i)var d=b[i];parseFloat(b[i])>parseFloat(this.bounds[c])&&(a[c-1]=""+d+this.separator+b[i-1],d=b[i],c++);if(c==this.bounds.length-1)return a[c-1]=""+d+this.separator+b[b.length-1],this.inner_ranges=a}};this.getSortedlist=function(){return this.sorted().join(", ")};this.getHtmlLegend=function(a,b,c,d,e,g){var f="",h=[];this.doCount();ccolors=null!=a?a:this.colors;lg=null!=b?b:"Legend";getcounter=null!=c?!0:!1;fn=null!=d?d:function(a){return a};
null==e&&(e="default");if("discontinuous"==e&&(this.getInnerRanges(),-1!==this.counter.indexOf(0))){if(this.silent)this.log("[silent mode] Geostats cannot apply 'discontinuous' mode to the getHtmlLegend() method because some classes are not populated.\nPlease switch to 'default' or 'distinct' modes. Exit!",!0);else throw new TypeError("Geostats cannot apply 'discontinuous' mode to the getHtmlLegend() method because some classes are not populated.\nPlease switch to 'default' or 'distinct' modes. Exit!");
...
a+f+"</div>",h.push(a);else for(i=0;i<this.bounds.length;i++)!0===getcounter&&(f=' <span class="geostats-legend-counter">('+this.counter[i]+")</span>"),a=fn(this.bounds[i]),a='<div><div class="geostats-legend-block" style="background-color:'+ccolors[i]+'"></div> '+a+f+"</div>",h.push(a);"DESC"===g&&h.reverse();e='<div class="geostats-legend"><div class="geostats-legend-title">'+lg+"</div>";for(i=0;i<h.length;i++)e+=h[i];return e+"</div>"}};this.objectID=(new Date).getUTCMilliseconds();this.log("Creating new geostats object");
"undefined"!==typeof h&&0<h.length?(this.serie=h,this.setPrecision(),this.log("Setting serie ("+h.length+") : "+h.join())):this.serie=[];this.getJenks=this.getClassJenks;this.getJenks2=this.getClassJenks2;this.getGeometricProgression=this.getClassGeometricProgression;this.getEqInterval=this.getClassEqInterval;this.getQuantile=this.getClassQuantile;this.getStdDeviation=this.getClassStdDeviation;this.getUniqueValues=this.getClassUniqueValues;this.getArithmeticProgression=this.getClassArithmeticProgression}});
